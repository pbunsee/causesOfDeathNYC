var eish = (function(myApp){
  ...
  myApp.drawHorizBarChart = function(plotValues, xAxisTitle, yAxisTitle){
  ...
  myApp.drawAllHorizBarCharts = function(){
    console.log("started at tooltip init");
    eish.tooltip().init();
    console.log("whichCharts init");
    var whichCharts = eish.chartConfig();
    console.log("whichCharts iterate");
    ...
    console.log("draw each chart horiz");
              eish.drawHorizBarChart(chartData, xAxisTitle, yAxisTitle);
            }
            else
            {
