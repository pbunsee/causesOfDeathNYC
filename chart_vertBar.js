var eish = (function(myApp){
  ...
  myApp.drawVertBarChart = function(plotValues, xAxisTitle, yAxisTitle){
  ...
  myApp.drawAllVertBarCharts = function(){
    eish.tooltip().init();
    ...
    Object.keys(whichCharts).forEach(function(d,i){ 
            if ( whichCharts[d] instanceof Object ) 
            {
              ...
              eish.drawVertBarChart(chartData, xAxisTitle, yAxisTitle);
              //if ( xAxisTitle == "Cause" ) 
              //{
